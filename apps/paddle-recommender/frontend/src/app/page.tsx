      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
            Get personalized paddle recommendations based on your skill level, play style, and preferences. 
            Or explore our comprehensive database of paddles with detailed specifications and expert reviews.
          </p>
